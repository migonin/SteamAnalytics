...
public class User: CoreStoreObject {
    ...
    public let friends = Relationship.ToManyOrdered<User>("friends", inverse: { $0.friendOf }, deleteRule: .cascade)

    //To make CoreData happy
    public let friendOf = Relationship.ToManyUnordered<User>("friendOf", deleteRule: .nullify)
}

...
public struct AlamofireUsersAPIClient: UsersAPIClienting {
    ...
    public func getUsers(request: URLRequest, completionHandler: @escaping (Result<UsersResponse, Error>) -> Void) {
        requestDecodable(request, completionHandler: completionHandler)
    }

    public func getUserFriends(request: URLRequest, completionHandler: @escaping (Result<FriendsResponse, Error>) -> Void) {
        requestDecodable(request, completionHandler: completionHandler)
    }
